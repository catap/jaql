 ...
 * 
 */
public final class LongMetaGetter extends MetaGetter
{
  /**
   * @param name
   * @param getter
   * @param setter
   */
  public LongMetaGetter(String name, Method getter, Method setter)
  {
  ...
  public void copy(Object toObject, Object fromObject)
      ...
      InvocationTargetException
  {
    long x = (Long) getter.invoke(fromObject);
