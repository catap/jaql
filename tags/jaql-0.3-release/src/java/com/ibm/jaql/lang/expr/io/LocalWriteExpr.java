 ...
 * 
 */
@JaqlFn(fnName = "localWrite", minArgs = 2, maxArgs = 3)
public class LocalWriteExpr extends MacroExpr
{
  /**
   * @param exprs
   */
  public LocalWriteExpr(Expr[] exprs)
  {
    super(exprs);
  }
  ...
  public Expr expand(Env env) throws Exception
  {
    ...
    NameValueBinding tField = new NameValueBinding(Adapter.TYPE_NAME,
        new ConstExpr(new JString("local")));
