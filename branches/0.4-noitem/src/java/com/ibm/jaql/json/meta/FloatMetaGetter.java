 ...
 * 
 */
public final class FloatMetaGetter extends MetaGetter
{
  /**
   * @param name
   * @param getter
   * @param setter
   */
  public FloatMetaGetter(String name, Method getter, Method setter)
  {
  ...
  public void copy(Object toObject, Object fromObject)
      ...
      InvocationTargetException
  {
    float x = (Float) getter.invoke(fromObject);
