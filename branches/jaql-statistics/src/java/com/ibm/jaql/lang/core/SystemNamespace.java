...
import com.ibm.jaql.lang.expr.record.FieldSortInfo;
import com.ibm.jaql.lang.expr.record.FieldsFn;
import com.ibm.jaql.lang.expr.record.NamesFn;
import com.ibm.jaql.lang.expr.record.PathValues;
import com.ibm.jaql.lang.expr.record.PathsFn;
...
import com.ibm.jaql.lang.util.BloomFilterFn;
import com.ibm.jaql.lang.util.BucketizeFn;
...
public final class SystemNamespace extends Namespace {
  ...
  private void registerAll()
  {
    ...
    register(new PathsFn.Descriptor());                  
    register(new PathValues.Descriptor());               
    register(new FieldSortInfo.Descriptor());         
    register(new BucketizeFn.Descriptor());           
    register(new BloomFilterFn.Descriptor());         
