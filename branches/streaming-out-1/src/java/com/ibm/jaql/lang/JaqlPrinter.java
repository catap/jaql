...
public interface JaqlPrinter {
   ...
   * @throws Exception
   */
  public void print(Expr expr, Context ctx) throws Exception;

  /**
   * Print explain JSON value.
   * 
   * @param v explain JSON value
   * @throws IOException
   */
  public void printExplain(JsonValue v) throws IOException;
