 ...
 * 
 */
public class SpanBeginFn extends MacroExpr
{
  public static final ConstExpr BEGIN_EXPR = new ConstExpr(SpanSelectFn.BEGIN);
  
  public static class Descriptor extends DefaultBuiltInFunctionDescriptor.Par11
  {
    public Descriptor()
    {
      super("span_begin", SpanBeginFn.class);
    }
  }
