 ...
 * 
 */
public final class DoubleMetaGetter extends MetaGetter
{
  /**
   * @param name
   * @param getter
   * @param setter
   */
  public DoubleMetaGetter(String name, Method getter, Method setter)
  {
  ...
  public void copy(Object toObject, Object fromObject)
      ...
      InvocationTargetException
  {
    double x = (Double) getter.invoke(fromObject);
