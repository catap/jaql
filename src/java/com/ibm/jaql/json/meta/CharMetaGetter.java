 ...
 * 
 */
public final class CharMetaGetter extends MetaGetter
{
  /**
   * @param name
   * @param getter
   * @param setter
   */
  public CharMetaGetter(String name, Method getter, Method setter)
  {
  ...
  {
    char x = (Character) getter.invoke(obj);
  ...
  public void copy(Object toObject, Object fromObject)
      ...
      InvocationTargetException
  {
    char x = (Character) getter.invoke(fromObject);
