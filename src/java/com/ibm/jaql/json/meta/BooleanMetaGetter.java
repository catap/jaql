 ...
 * 
 */
public final class BooleanMetaGetter extends MetaGetter
{
  /**
   * @param name
   * @param getter
   * @param setter
   */
  public BooleanMetaGetter(String name, Method getter, Method setter)
  {
  ...
  public void copy(Object toObject, Object fromObject)
      ...
      InvocationTargetException
  {
    boolean x = (Boolean) getter.invoke(fromObject);
