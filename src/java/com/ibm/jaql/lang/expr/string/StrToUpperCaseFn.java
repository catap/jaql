...
public class StrToUpperCaseFn extends Expr
{
  public static class Descriptor extends DefaultBuiltInFunctionDescriptor.Par11
  {
    public Descriptor()
    {
      super("strToUpperCase", StrToUpperCaseFn.class);
    }
  }
  
  protected MutableJsonString text;
  
  public StrToUpperCaseFn(Expr... exprs)
  {
    super(exprs);
  }
  ...
  protected JsonString evalRaw(Context context) throws Exception
  {
    ...
    // TODO: optimize: if s is all upper case already, just return it.
    // TODO: optimize: do conversions on utf 8 bytes
    text.setCopy(s.toString().toUpperCase());
    return text;
  }
}
