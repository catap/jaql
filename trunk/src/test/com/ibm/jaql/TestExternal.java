...
import com.ibm.jaql.JaqlScriptTestCase.CountExplainHandler;
import com.ibm.jaql.JaqlScriptTestCase.DecompileExplainHandler;
import com.ibm.jaql.JaqlScriptTestCase.Mode;
import com.ibm.jaql.JaqlScriptTestCase.TestExceptionHandler;
import com.ibm.jaql.JaqlScriptTestCase.TestPrinter;
...
public class TestExternal extends JaqlScriptTestCase {
    ...
    public TestExternal (String script) {
        super(script);
    }
