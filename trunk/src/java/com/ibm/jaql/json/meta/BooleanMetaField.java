 ...
 * 
 */
public class BooleanMetaField extends MetaField
{
  /**
   * @param name
   * @param field
   */
  public BooleanMetaField(String name, Field field)
  {
    super(name, field);
  }
  ...
  {
    boolean x = field.getBoolean(fromObject);
    field.setBoolean(toObject, x);
  }
}
