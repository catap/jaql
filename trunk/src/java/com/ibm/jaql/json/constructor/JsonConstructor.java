...
public class JsonConstructor
{
   ...
   * @return
   */
  public static JsonValue eval(String fnName, JsonValue[] args)
  {
    JMethod fn = get(fnName, args.length);
    JsonValue result = fn.eval(args);
    return result;
  }
}
...
class JMethod // TODO: unify with Jaql UDFs
{
   ...
   * @return
   */
  public JsonValue eval(JsonValue[] args)
  {
    try
    {
      JsonValue result = (JsonValue) method.invoke(instance, (Object[]) args);
      return result;
    }
    catch (Exception ex)
    {
